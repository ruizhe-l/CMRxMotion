...
from customize.timm_models import EfficientNet
...
root_output_path = f'./results/effnet_{mag_name}'
...
for ifold in range(1, 6):
    ...
    # build model
    net = EfficientNet(num_classes=3, pretrained=pretrained, input_channels=input_channels, freeze=freeze)
